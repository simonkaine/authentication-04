...
module.exports = class Service {
  ...
  static async createUser({ email, password, titleOfRole }) {
    // console.log('!! SERVICE DATA', email, password, titleOfRole); // console log <<<<<<<<<<<
    ...
    const newUser = await User.insert(email, passwordHash, titleOfRole);
